    ...
    <Dialog as="div" @close="closeModal" class="relative z-10">
      ...
      <div class="fixed inset-0 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4 text-center">
          ...
          >
            <DialogPanel
              class="w-full max-w-md transform overflow-hidden rounded-2xl bg-slate-800 p-6 text-left align-middle shadow-xl transition-all border-slate-700 border"
            >
              <div class="flex space-x-3">
                ...
                <DialogTitle as="h3" class="text-lg font-medium leading-6 text-slate-300">
                  Are you sure you want to delete this tweet?
                </DialogTitle>
              </div>
              <div class="text-sm text-slate-400">
                <div>
                  <p v-if="tweet.tweet" class="my-3">{{ tweet.tweet }}</p>
